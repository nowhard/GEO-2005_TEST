...
/*	adc_channels[ADC0CON2&0x7].ADC_BUF_UN[adc_channels[ADC0CON2&0x7].adc_buf_counter].ADC_CHAR[0]=0x0;//получим результат
	...
	adc_channels[ADC0CON2&0x7].ADC_BUF_UN[0].ADC_CHAR[0]=0x0;//получим результат
	adc_channels[ADC0CON2&0x7].ADC_BUF_UN[0].ADC_CHAR[1]=ADC0H;
	adc_channels[ADC0CON2&0x7].ADC_BUF_UN[0].ADC_CHAR[2]=ADC0M;
	adc_channels[ADC0CON2&0x7].ADC_BUF_UN[0].ADC_CHAR[3]=ADC0L;
